...
public:
	...
	static SendBufferRef Make_C_TEST(uint64 id, uint32 hp, uint16 attack, vector<BuffData> buffs, string name);
	static SendBufferRef Make_C_LOGIN();
	static SendBufferRef Make_C_CHAT(string msg);
